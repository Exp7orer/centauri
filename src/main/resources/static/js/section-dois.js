...
//        console.warn('Nenhum ícone de estrela (.starIcon) foi encontrado.');
//    }
//
...
//
//            if (!estrelaLike) {
//                console.error('Elemento #estrela-like não encontrado dentro do .estrela.', icon);
//                return;
//            }
//
...
//                estrelaLike.checked = true;
//            } else {
//                icon.classList.remove('fa-solid');
//                icon.classList.add('fa-regular');
//                icon.style.color = '#fff';
//                estrelaLike.checked = false;
//            }
//        });
//    });
